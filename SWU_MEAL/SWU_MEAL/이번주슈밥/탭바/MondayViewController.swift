...
final class MondayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.setupLayout()
        self.setupServer(date: "2023-10-13", time: "조식")
...
private extension MondayViewController {
    ...
    /// API 불러오기
    private func setupServer(date: String, time: String) {
        apiManager.weekdayMealGetData(date: date, time: time) { [weak self] result in
            switch result {
