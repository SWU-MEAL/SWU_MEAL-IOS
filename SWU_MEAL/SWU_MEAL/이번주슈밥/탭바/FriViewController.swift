...
final class FriViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.setupMorningServer(date: "2023-10-13")
        self.setupLunchServer(date: "2023-10-13", type: "샬롬", corner: "한식")
        self.setupDinnerServer(date: "2023-10-13")
    }
}

private extension FriViewController {
    ...
    @objc func didTapLunchButton(_ sender: UIButton) {
        if let corner = sender.titleLabel?.text {
            switch corner {
            case "한식코너":
                setupLunchServer(date: "2023-10-13", type: "샬롬", corner: "한식")
            case "일품코너":
                setupLunchServer(date: "2023-10-13", type: "샬롬", corner: "일품")
            case "스낵코너":
                setupLunchServer(date: "2023-10-13", type: "샬롬", corner: "스낵")
            case "교직원":
                setupLunchServer(date: "2023-10-13", type: "교직원", corner: "")
            default:
                print("nil")
            }
        }
